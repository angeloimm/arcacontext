                        ...
                        <tiles:putAttribute name="head">
                            ...
                            <script type="text/x-handlebars-template" id="templateTitolo">
                                ...
                                <div id="erroreCancellazioneContainer" class="alert alert-danger">
                                    <i class="fa fa-exclamation-triangle red" aria-hidden="true"></i>&nbsp;<strong>Attenzione!</strong> È avvenuto un errore durante la cancellazione del titolo
                                    <br/> Ti preghiamo di riprovare più tardi.
                                </div>
								{{else if nonCancellabile}}
								<div id="erroreCancellazioneContainer" class="alert alert-danger">
                                    <i class="fa fa-exclamation-triangle red" aria-hidden="true"></i>&nbsp;<strong>Attenzione!</strong> Impossibile cancellare il titolo. Vi sono dati ad esso associati
                                </div>
                                {{else if erroriInserimento}}
                                <div id="erroreCancellazioneContainer" class="alert alert-danger">
                                    <i class="fa fa-exclamation-triangle red" aria-hidden="true"></i>&nbsp;<strong>Attenzione!</strong> È avvenuto un errore durante l'inserimento del titolo
                                    <br/> Ti preghiamo di riprovare più tardi.
                                </div>
								{{else if erroriModifica}}
                                <div id="erroreCancellazioneContainer" class="alert alert-danger">
                                    <i class="fa fa-exclamation-triangle red" aria-hidden="true"></i>&nbsp;<strong>Attenzione!</strong> È avvenuto un errore durante la modifica del titolo
                                    <br/> Ti preghiamo di riprovare più tardi.
                                </div>
                                {{else if successo}}
                                <div id="erroreCancellazioneContainer" class="alert alert-success" role="alert">
                                    <i class="fa fa-check green" aria-hidden="true"></i>&nbsp;<strong>Successo!</strong> Cancellazione titolo terminata con successo
                                </div>
                                {{else if conferma}}
                                <div id="cancellazioneDomandaContainer" class="alert alert-warning" role="alert">
                                    Confermi di voler cancellare il titolo {{#if cf}} associata al codice fiscale <strong>{{cf}}</strong> {{/if}} dell'anno <strong>{{anno}}</strong>, graduatoria <strong>{{tipo}}</strong>,codice <strong>{{codice}}</strong> {{#if descrizione}} e descrizione:
                                    <br>
                                    <i>{{descrizione}}</i> ? {{/if}}
                                    <br/>
                                    <br/>
                                ...
                                <div class="row">
                                    <form method="POST" id="form_titolo">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="descrizione_breve" required maxlength="50" data-error="Inserire non più di 50 caratteri" />
										</div>
								...
								<div class="row">
 								<form method="POST" id="form_titolo">
									<div class="alert alert-warning col-md-12">
                                 	...
                                 	<div class="form-group col-md-12">
                                            <label for="codice" class="control-label">Descrizione breve (*)</label>
                                            <input type="text" class="form-control" id="descrizione_breve" required="true" maxlength="50" data-error="Inserire non più di 50 caratteri" />
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="descrizioneTitolo" class="control-label">Descrizione (*)</label>
                                ...
                                <div id="erroreCancellazioneContainer" class="alert alert-success" role="alert">
                                    <i class="fa fa-check green" aria-hidden="true"></i>&nbsp;<strong>Successo!</strong> Modifica titolo avvenuta con successo
                                </div>
                                {{else if insertSuccess}}
                                <div id="erroreCancellazioneContainer" class="alert alert-success" role="alert">
                                    <i class="fa fa-check green" aria-hidden="true"></i>&nbsp;<strong>Successo!</strong> Inserimento titolo effettuato con successo
                                </div>
                                {{/if}}
                            </script>
                            <script type="text/javascript" charset="UTF8">
                                var elencoTitoliDt = null;
                                ...
                                $(function() {
                                    ...
                                    $("#ricercaTitoli").click(function(evt) {
                                        //Prevengo il propagarsi dell'evento
                                        evt.preventDefault();
                                        reloadTabella();
                                    });
                                    elencoTitoliDt = $("#elencoTitoli")
                                        .DataTable({
                                            ...
                                            "ajax": {
                                                "url": '<spring:url value="/table/elencoTitoli.json" />',
                                                "dataSrc": "payload"
                                            },
                                            "deferRender": true,
                                            "columnDefs": [{
                                                ...
                                                "render": function(data, type,
                                                    row) {
                                                    if (row.descrizioneBreve && row.descrizioneBreve !== "") {
                                                ...
                                                "render": function(data, type,
                                                    row) {
                                                    return '<a href="#" class="cancellazioneTitolo" data-toggle="tooltip" title="Cancella titolo"><i class="fa fa-times red" aria-hidden="true"></i></a>'
                                                },
                                                "name": "",
                                                "orderable": false,
                                                "targets": 5
                                    ...
                                    $('#elencoTitoli tbody').on(
                                        'click',
                                        'td a.cancellazioneTitolo',
                                        function(evt) {
                                            evt.preventDefault();
                                            var tr = $(this).closest('tr');
                                            var row = elencoTitoliDt.row(tr);
                                            var dati = row.data();
                                            confermaCancellazioneTitolo(dati.anno, dati.tipo,
                                                dati.codice, dati.descrizione);
                                        });
                                    $('#elencoTitoli tbody').on('click','tr .dettaglioClickable',function(evt) {
                    					evt.preventDefault();
                    					var tr = $(this).closest('tr');
                    					var row = elencoTitoliDt.row(tr);
                    					var datiTitolo = row.data();
                    					findTitolo(datiTitolo);
                    				});
                                    ...
                                    $('#stampaTabellaTitoli').click(function() {
                                        ...
                                        var url = Constants.contextPath + 'report/stampaRicercaTitoli?codice=' + codice + '&descrizione=' + descrizione;
                                ...
                                function reloadTabella() {
                                    if (elencoTitoliDt && elencoTitoliDt != null) {
                                        var baseUrl = '<spring:url value="/table/elencoTitoli.json" />';
                                        ...
                                        elencoTitoliDt.ajax.url(baseUrl).load();
                                    }
                                }
                                function confermaCancellazioneTitolo(anno, tipo, codice,
                                    descrizione) {
                                    BootstrapDialog.show({
                                        ...
                                        buttons: [{
                                            ...
                                            action: function(dialogRef) {
                                                ...
                                                cancellaTitolo(anno, tipo, codice, dialogRef);
                                ...
                                function cancellaTitolo(anno, tipo, codice, dialogRef) {
                                    //cancellazioneDomandaContainer
                                    $.ajax({
                                            url: '<spring:url value="/table/cancellaTitolo/' + anno + '/' + tipo + '/' + codice + '.json" />',
                                            dataType: 'json',
                                            ...
                                            success: function(data) {
                                                ...
                                                if (codiceEsito == 200) {
                                                    ...
                                                    if (elencoTitoliDt != null) {
                                                        elencoTitoliDt.ajax.reload();
                                                    }
                                ...
                                function salvaTitolo(obj, dialogRef) {
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<spring:url value="/table/salvaTitolo.json" />',
                                        dataType: 'json',
                                ...
                                function modificaTitolo(obj, dialogRef){
                                	// Controllo sui campi obbligatori
                                	if($('#form_titolo').validator('validate').has('.has-error').length > 0 ){
                                		$('#error').css('display','block');
                            			return;
                                    ...
                                    $.ajax({
                                        type: 'POST',
                                        url: '<spring:url value="/table/modificaTitolo.json" />',
                                        dataType: 'json',
                                        data: JSON.stringify(obj),
                                        contentType: 'application/json; charset=UTF-8',
                                        success: function(data) {
                                ...
                                <div class="container">
                                    <div class="row margin20">
                                        <div class="form-group col-md-2">
                                            <label for="anno" class="control-label">Anno</label>
                                            <input type="text" class="form-control height40" id="anno" readonly value="${sessionScope.anno}">
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="tipo" class="control-label">Tipo grad.</label>
                                            <input type="text" class="form-control height40" id="tipo" readonly value="${sessionScope.tipoGraduatoria}">
                                        </div>
                                        <c:choose>
                                            <c:when test="${sessionScope.tipoGraduatoria=='MG'}">
                                                <div class="form-group col-md-3">
                                                    <label for="tipo_esteso" class="control-label">Tipo grad.
                                                    </label>
                                                    <input type="text" class="form-control height40" id="tipo_esteso" readonly value="Graduatoria medici generici">
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" class="form-control height40" id="tipo_esteso" readonly value="Graduatoria pediatri" required>
                                                </div>
                                            </c:otherwise>
                                        </c:choose>
                                        <div class="form-group col-md-1">
                                            <label for="stato" class="control-label">Stato grad.</label>
                                            <input type="text" class="form-control height40" id="stato" readonly value="AP">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="utente" class="control-label">Utente</label>
                                            <input type="text" class="form-control height40" id="utente" readonly value="${utente}">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="codiceFunzione" class="control-label">Codice funzione
                                            </label>
                                            <input type="text" class="form-control height40" id="codiceFunzione" readonly value="${funzione}">
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                <div class="panel panel-default panel_padding_l_r">
                                                    <div class="panel-body panel_min_height home_news">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <label for="anno" class="control-label">Anno</label>
                                                            <input type="text" class="form-control" id="anno" readonly value="${sessionScope.anno}" required>
                                                        </div>
                                                        <!-- TIPO GRADUATORIA -->
                                                        <div class="form-group col-md-4">
                                                            <label for="tipo" class="control-label">Tipo grad.</label>
                                                            <input type="text" class="form-control" id="tipo" readonly value="${sessionScope.tipoGraduatoria}" required>
                                                        </div>
                                                        <!-- FORM RICERCA -->
                                                        <form  role="form">
                                                            <!-- CODICE -->
                                                            ...
                                                            <div class="form-group col-md-5 margin10">
                                                                <button type="submit" id="ricercaTitoli" class="btn btn-default btn-large button_salva">
                                                                    <i class="fa fa-search" aria-hidden="true"></i>&nbsp;Ricerca
                                                                </button>
                                                                <button type="button" class="btn btn-default btn-large button_salva" id="nuovoTitolo">
                                                                    <i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Nuovo
                                                                </button>
                                                                <button type="button" class="btn btn-default btn-large button_salva" id="stampaTabellaTitoli">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="bs-panel">
                                                <div class="panel panel-default panel_padding_l_r">
                                                    <div class="panel-body panel_min_height home_news">
                                                        <table id="elencoTitoli" class="datatables-table table table-striped table-bordered table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th>Anno</th>
                                                                    <th>Grad</th>
